...
const models = {
  ...
  BookingRequestModel: BookingRequestModel.init(sequelize, Sequelize),
};
...
BookingRequestModel.belongsTo(UserModel, { foreignKey: 'userId', });
BookingRequestModel.belongsTo(DepositModel, { foreignKey: 'depositId', });
